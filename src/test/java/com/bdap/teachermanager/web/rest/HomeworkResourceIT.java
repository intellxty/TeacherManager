...
public class HomeworkResourceIT {
    ...
    public void createHomework() throws Exception {
        ...
        assertThat(testHomework.getOwner()).isEqualTo(DEFAULT_OWNER);
        assertThat(testHomework.getClassName()).isEqualTo(DEFAULT_CLASS_NAME);
        assertThat(testHomework.getEditTime()).isEqualTo(DEFAULT_EDIT_TIME);
    ...
    @Test
    public void checkEditTimeIsRequired() throws Exception {
        int databaseSizeBeforeTest = homeworkRepository.findAll().size();
        // set the field null
        homework.setEditTime(null);
    ...
    public void updateHomework() throws Exception {
        ...
        assertThat(testHomework.getOwner()).isEqualTo(UPDATED_OWNER);
        assertThat(testHomework.getClassName()).isEqualTo(UPDATED_CLASS_NAME);
        assertThat(testHomework.getEditTime()).isEqualTo(UPDATED_EDIT_TIME);
