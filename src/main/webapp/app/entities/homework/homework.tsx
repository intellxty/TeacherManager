...
export class Homework extends React.Component<IHomeworkProps, IHomeworkState> {
  ...
  render() {
    const { homeworkList, match, totalItems } = this.props;
    return (
      <div>
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('teachermanagerApp.homework.home.search')}
                  />
