...
export class HomeworkUpdate extends React.Component<IHomeworkUpdateProps, IHomeworkUpdateState> {
  ...
  saveEntity = (event, errors, values) => {
    values.lastEditTime = convertDateTimeToServer(values.lastEditTime);
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : homeworkEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="lastEditTimeLabel" for="homework-lastEditTime">
                    <Translate contentKey="teachermanagerApp.homework.lastEditTime">Last Edit Time</Translate>
                  </Label>
                  <AvInput
                    id="homework-lastEditTime"
                    type="datetime-local"
                    className="form-control"
                    name="lastEditTime"
                    placeholder={'YYYY-MM-DD HH:mm'}
                    value={isNew ? null : convertDateTimeFromServer(this.props.homeworkEntity.lastEditTime)}
                  />
                </AvGroup>
